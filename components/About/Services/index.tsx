        ...
        <div className="grid grid-cols-12 items-center gap-10">
          <div className="lg:col-span-6 col-span-12">
            <p className="text-dark/75 dark:text-white/75 text-base font-semibold flex gap-2.5 items-center">
              <GiMedicines className="text-2xl text-primary" />
          ...
          <div className="lg:col-span-6 col-span-12">
            <div className="relative rounded-2xl overflow-hidden group">
              <Link href="/services/diagnostics">
                <Image
                  src="/images/services/diagnostics.avif"
                  alt="Диагностика"
                  width={680}
                  height={386}
                  className="w-full"
          ...
          <div className="lg:col-span-6 col-span-12">
            <div className="relative rounded-2xl overflow-hidden group">
              <Link href="/services/plastic-surgery">
                <Image
                  src="/images/services/plastic.avif"
          ...
          <div className="lg:col-span-3 col-span-6">
            <div className="relative rounded-2xl overflow-hidden group">
              <Link href="/services/checkup">
                <Image
                  src="/images/services/checkup-1.avif"
                  alt="Check-up"
                  width={320}
                  height={386}
                  className="w-full"
          ...
          <div className="lg:col-span-3 col-span-6">
            <div className="relative rounded-2xl overflow-hidden group">
              <Link href="/services/cardiology">
                <Image
                  src="/images/services/cardiology.avif"
                  alt="Кардиология"
                  width={320}
                  height={386}
                  className="w-full"
